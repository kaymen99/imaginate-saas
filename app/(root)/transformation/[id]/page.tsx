...
const TransformationPage = async ({ params: { id } }: SearchParamProps) => {
  ...
  return (
    <div className="flex flex-col lg:flex-row p-10 gap-4 max-lg:space-y-12 mb-8">
      <div className="max-h-80 flex flex-col gap-y-4 w-full lg:w-1/4 border-2 rounded-lg border-slate-500 p-6 lg:mt-20">
        ...
        {image.width && (
          <div className="p-14-medium md:p-16-medium flex gap-2">
            ...
            <p className="font-semibold text-blue-500">{image.width + " px"}</p>
          </div>
        )}
        {image.height && (
          <div className="p-14-medium md:p-16-medium flex gap-2">
